angular.module('chatroom').service('messageService', function($http){
  ...
  this.postMessage = function(message) {
    ...
    //post to the same data, but must include what it is in the object.  The first 'message' is just the key, and the second 'message' is the actual test created by the ng-model in the html.  
