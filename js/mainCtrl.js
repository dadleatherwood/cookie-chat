angular.module('chatroom').controller('mainCtrl', function($scope, messageService){
  ...
  $scope.postMessage = function(message) {
    messageService.postMessage(message)  //receives the 'promise'(posts the message to the data)
    .then(function(response){
        getMessages()  //then returns the getMessages method immediatly so the user knows it worked
    })
  }
